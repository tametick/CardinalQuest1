...
class HxlSave  {
	...
	public function bind(Name:String):Bool {
		...
		try {
			...
			HxlGraphics.log("WARNING: There was a problem binding to\nthe shared object data from HxlSave.");
			name = null;
			_so = null;
			data = null;
			return false;
	...
	public function write(FieldName:String,FieldValue:Dynamic,?MinFileSize:Int=0):Bool {
		if (_so == null) {
			HxlGraphics.log("WARNING: You must call HxlSave.bind()\nbefore calling HxlSave.write().");
			return false;
		}
	...
	public function forceSave(?MinFileSize:Int=0):Bool {
		if (_so == null) {
			HxlGraphics.log("WARNING: You must call HxlSave.bind()\nbefore calling HxlSave.forceSave().");
			return false;
		}
