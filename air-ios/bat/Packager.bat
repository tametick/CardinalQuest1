...
call c:\AdobeAIRSDK\bin\adt -package -target ipa-test -provisioning-profile "bat\cq1_dev_oct_2013.mobileprovision" -storetype pkcs12 -keystore "bat\iphone_dev_cert_jday.p12" -storepass cqdev ./bin/CQ.ipa application.xml -C ./bin/package .
goto done
